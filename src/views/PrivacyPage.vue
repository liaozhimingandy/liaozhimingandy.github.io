<template>
  <div class="container">
    <p>
      感谢您使用我们提供的服务，为了给您提供更准确、更有个性化的服务，当我们向您提供服务时，可能会收集和使用您的信息。但我们将以高度的勤勉、审慎义务对待这些信息。本《隐私协议》旨在帮助您了解您在使用我们提供的服务的过程中，我们将会收集哪些信息，为什么收集该些信息，我们将如何使用这些信息以及您如何查看并删除该些信息。除本《隐私协议》另有规定外，在未征得您事先许可的情况下，我们不会将这些信息对外披露或向第三方提供。本《隐私协议》与您所使用的我们的服务息息相关，我们也希望您能够仔细阅读，并在需要时，按照本《隐私协议》的指引，作出您认为适当的选择。在阅读完本政策之后，如您对本《隐私政策》或与本《隐私政策》相关的事宜有任何问题，请与我们客服邮箱联系。
    </p>
    <p>
      您使用或继续使用本应用服务，都表示您同意我们按照本《隐私政策》收集、使用、储存和分享您的信息。
    </p>
    <p>
      目录
    </p>
    ...
    <p>
      当您使用服务时，我们可能收集和汇总诸如用户的来源途径、访问顺序等信息，例如记录使用服务的每个用户的来源途径、浏览器软件等。
    </p>
    <p>
      （二）有关个人身份的信息：
    </p>
    <p>
      当您使用服务时，我们可能收集和汇总或要求您提供有关个人身份的信息，例如个人身份证明（包括身份证、护照、驾驶证等）；生日、籍贯、性别、兴趣爱好、个人电话号码、面部特征；网络身份标识信息（包括系统账号、IP地址、电子邮箱地址及与前述有关的密码、口令、口令保护答案等）；个人财产信息（交易记录、余额、优惠券、游戏类兑换码、银行卡信息等）；通讯信息；个人上网记录和日志信息（包括网站浏览记录、软件使用记录、点击记录、操作日志等）；设备信息（包括设备型号、设备MAC地址、操作系统类型、设备设置）；软件列表唯一设备识别码（如IMEI/android
      ID/IDFA/OPENUDID/GUID、SIM卡IMSI信息等在内的描述个人常用设备基本情况的信息）；位置信息（包括行程信息、精准定位信息、住宿信息、经纬度等）。
    </p>
    <p>
      我们收集您的信息主要是为了您和其他用户能够更容易和更满意地使用服务。的目标是向所有的互联网用户提供安全、刺激、有趣及有教益的上网经历。而这些信息有助于我们实现这一目标。
    </p>
    <p>
      请注意，如您在服务中其他用户可见的公开区域内上传或发布的信息中、您对其他人上传或发布的信息作出的回应中公开您的个人信息，该等信息可能会被他人收集并加以使用。当您发现的用户不正当地收集或使用您或他人的信息时，请联系我们。
    </p>
    <p>
      二、我们如何收集和使用信息
    </p>
    ...
    <p>
      2、其他方分享的您的信息。亦即其他方使用服务时所提供有关您的共享信息。
    </p>
    <p>
      3、我们获取的您的信息。您在使用服务时，我们收集、汇总、记录的信息，例如日志信息、位置信息、设备信息等。
    </p>
    <p>
    ...
    <p>
      通过使用COOKIES，我们向用户提供简单易行并富个性化的网络体验。一个COOKIES是少量的数据，它们从一个网络服务器送至您的浏览器并存在计算机硬盘上。我们使用COOKIES是为了让其用户可以受益。比如，为使得虚拟社区的登录过程更快捷，您可以选择把用户名存在一个COOKIES中。这样下次当您要登录的服务时能更加方便快捷。COOKIES能帮助我们确定您连接的页面和内容，您在特定服务上花费的时间和您所选择的服务。
    </p>
    <p>
    ...
    <p>
      ...
      BEACON收集的非个人身份信息汇总提供给广告商和其他伙伴，用于分析您和其他用户如何使用服务并用于广告服务。
    </p>
    <p>
      服务上可能会有广告商和其他合作方放置的COOKIES和WEB BEACON。这些COOKIES和WEB
    ...
    <p>
      为便于我们为您提供服务，您需要提供基本注册信息，例如手机号码、电子邮箱地址等，并创建您的用户名和密码。在部分单项服务中，如果您仅需使用浏览、搜索等基本服务，您不需要注册成为用户及提供上述信息。
    </p>
    <p>
      2、向您提供商品或服务
    </p>
    ...
    <p>
      （1）在部分服务项目中，为便于向您交付商品或服务，您需提供收货人个人身份信息、姓名、收货地址、邮政编码、收货人、联系电话、支付状态等信息。如果您拒绝提供此类信息，我们将无法完成相关交付服务。如您通过服务为其他人订购商品或服务，您需要提供该实际订购人的前述信息。向我们提供该实际订购人的前述信息之前，您需确保您已经取得其授权同意。
    </p>
    <p>
    ...
    <p>
      除以下情形外，未经您同意，我们不会与之外的任何第三方分享您的信息：
    </p>
    <p>
    ...
    <p>
      （三）我们仅允许有必要知晓这些信息的员工、合作伙伴访问您的信息，并为此设置了严格的访问权限控制和监控机制。我们同时要求可能接触到您的信息的所有人员履行相应的保密义务。如果未能履行这些义务，可能会被追究法律责任或被中止与的合作关系。
    </p>
    <p>
    ...
    <p>
      在通过服务与第三方进行沟通或购买商品及服务时，您不可避免的要向交易对方或潜在的交易对方披露自己的信息，如联络方式或者邮政地址等。请您妥善保护自己的信息，仅在必要的情形下向他人提供。
    </p>
    <p>
    ...
    <p>
      我们鼓励您更新和修改您的信息以使其更准确有效。您能通过服务访问您的信息，并根据对应信息的管理方式自行完成或要求我们进行修改、补充和删除。我们将采取适当的技术手段，尽可能保证您可以访问、更新和更正自己的信息或使用服务时提供的其他信息。
    </p>
    <p>
    ...
    <p>
      服务可能链接至第三方提供的社交媒体或其他服务（包括网站或其他服务形式）。包括：
    </p>
    <p>
      （1）您可利用“分享”键将某些内容分享到服务，或您可利用第三方服务登录服务。这些功能可能会收集您的信息（包括您的日志信息），并可能在您的电脑装置COOKIES，从而正常运行上述功能；
    </p>
    <p>
    ...
    <p>
      我们鼓励父母或监护人指导未成年人使用服务。我们建议未成年人鼓励他们的父母或监护人阅读本《隐私政策》，并建议未成年人在提交信息之前寻求父母或监护人的同意和指导。
    </p>
    <p>
      八、通知和修订
    </p>
    <p>
      我们可能适时修改本《隐私政策》的条款，该等修改构成本《隐私政策》的一部分。对于重大变更，我们会提供更显著的通知，您可以选择停止使用服务；在该种情况下，如您仍然继续使用服务的，即表示同意受经修订的本《隐私政策》的约束。
    </p>
    <p>
      任何修改都会将您的满意度置于首位。我们鼓励您在每次使用服务时都查阅我们的隐私政策。
    </p>
    <p>
    ...
    <p>
      如您有关于网络信息安全的投诉和举报，或您对本《隐私政策》、您的信息的相关事宜有任何问题、意见或建议，以及有关本声明或的隐私措施的问题请与的协调人联系。
    </p>
    <p>
      附件一：
    </p>
    ...
    <p>
      【注意】根据文化部制定的《网络游戏管理暂行办法》及《网络游戏服务格式化协议必备条款》（下称“必备条款”）的相关规定，为保障网络游戏用户（下称“用户”）的隐私权、规范对网络游戏用户个人信息的利用，特制定本政策。请用户仔细阅读以下全部内容（特别是粗体下划线标注的内容）。如用户不同意本政策的任意内容，请不要注册或使用服务。如用户进入注册程序，即表示用户与已达成协议，自愿接受本政策的所有内容。此后，用户不得以未阅读本政策的内容作任何形式的抗辩。
    </p>
    <p>
      尊重用户个人隐私是的一项基本政策。“隐私”是指用户在注册邮箱帐号时提供给的个人身份信息，包括但不限于用户注册资料中的姓名、个人有效身份证件号码、联系方式、家庭住址等。一贯积极地采取技术与管理等合理措施保障用户帐号的安全、有效；将善意使用收集的信息，采取各项有效且必要的措施以保护您的隐私安全，并使用商业上合理的安全技术措施来保护您的隐私不被未经授权的访问、使用或泄漏。
    </p>
    <p>
      附件二：
    </p>
    ...
    <p>
      支付在此特别提醒用户认真阅读、充分理解本政策各条款，特别是其中所涉及的免除支付责任或限制支付功能的条款、对用户权利限制条款、管辖与法律适用条款等。为了特别提示您限制、免责条款以及涉及到您的权益的等内容，这些条款可能以字体加粗形式提示您注意。
    </p>
    <p>
      为了更好的保护您的信息并告知您的信息收集、使用情况，我们制定了支付隐私政策，请您审慎阅读并选择接受或不接受本政策（未成年人应在监护人陪同下阅读）。当您同意《支付服务协议》时，即表示您已同意我们按照本政策收集、储存、使用和分享您的信息。除非您已阅读并接受本政策所有条款，否则您无权使用支付服务。如您遇到任何障碍或疑问，可联系本页面的客服联系邮箱。
    </p>
    <p>
      （一）用户个人信息的收集
    </p>
    <p>
      为了您可以正常使用支付服务，在下列情形下您需要向我们提供一些信息，我们也会在下列情形下向合法存有您信息的第三方收集您的信息。
    </p>
    <p>
      1、依据法律法规及监管规定履行反洗钱义务及进行实名制管理。
    </p>
    <p>
      (1)在您注册支付账户并使用支付服务时，按照反洗钱的相关规定，您需要提供您的姓名、国籍、性别、职业、住址、联系方式以及客户有效身份证件的种类、号码和有效期限。如您不提供上述信息，将无法注册账户或无法支付。同时为了验证该类信息的准确性和完整性，我们会将您提供的信息与合法存有您信息的机构（政府机关、事业单位、商业机构）进行验证核对。
    </p>
    <p>
      2、支付
    </p>
    <p>
      (1)为了您能使用快捷支付服务，在您开通快捷支付服务，将您的银行卡与支付账户绑定时，您需提供您的银行卡卡号、姓名、身份证号码、银行预留手机号。我们会将该等信息与发卡银行进行验证。如您不提供上述信息，将无法使用快捷支付服务。
    </p>
    <p>
      (2)当您向商家付款时，为了让您完成交易、实现交易目的，商家可在付款过程中，或付款成功后查看您使用的支付账户登录名、账户对应的姓名或昵称及该笔交易信息等。同时，商家会将您的支付金额、支付对象传输给我们以确认是否是您的真实意思表示。按照法律法规及监管规定，我们需要对商家进行管理，如识别、防止其套现或欺诈，商家会将购买商品、收货地址、联系方式提供给我们。如您不同意商家提供该等信息，则无法完成付款。
    </p>
    <p>
      (3)为了帮助您更安全、快速地登录、认证支付指令及使用支付提供的其他功能，支付为您提供人脸识别服务。当您选择我们提供的人脸识别服务时，需要您向我们提供您的人脸照片或人脸视频。
    </p>
    <p>
    ...
    <p>
      为了防止您的资金、个人信息被不法分子获取并侵害您的合法权益，我们需要收集您的下列信息以判断您账户的风险：当您使用支付服务时，我们可能会记录您使用的服务类别和方式、使用服务时的操作信息，如您的IP地址、移动设备所使用的版本和设备识别码、设备标识符、您的位置以及其他与支付服务相关的日志信息。为更准确地预防钓鱼网站、欺诈和木马病毒，我们可能会通过了解一些您的网络使用习惯、您常用的软件信息来判断风险，并可能会记录一些我们认为有风险的URL、APP或软件。您可以设置关闭收集位置功能，这样我们会停止对您的位置信息的收集，这样做不会影响您进行支付，但可能会影响我们判断是否安全的效果。
    </p>
    <p>
      5、为了提供个性化服务及改进服务质量
    </p>
    <p>
      为提升您的服务体验及改进服务质量，或为防范风险，或者为您推荐更优质或更适合的服务，我们会收集您与客户服务团队联系时提供的信息，收集您参与问卷调查时向我们发送的问卷答复信息，及您使用的服务类别和方式、使用服务时的操作信息以及有关您曾使用的移动应用（APP）和其他软件的信息；还会向支付关联公司和合作伙伴收集其合法留存的您的行为信息、交易信息。我们会对这些信息进行统计、分析，以为您提供更加准确、个性、流畅及便捷的服务。
    </p>
    <p>
      6、为了提供服务状态通知及查询服务
    </p>
    <p>
      为了遵守法律法规及监管规定，也为了便于您查询交易状态或历史记录，我们会将您使用支付服务时的身份信息、交易信息、行为信息进行存档，并严格按照法律法规的规定对这些信息进行妥善保管。为了使您知晓使用支付服务的状态，我们会根据这些信息向您发送服务状态通知。
    </p>
    <p>
      7、设备权限调用
    </p>
    <p>
      为向您提供安全、便捷的服务功能，支付可能会调用您的一些设备权限，以下是我们可能调用的设备权限列表及对应的使用目的说明，您有权随时选择关闭下列权限的授权，但可能会影响您使用支付的部分或全部功能。
    </p>
    <p>
      设备权限对应业务功能调用权限的目的是否询问用户可否关闭权限如果关闭会影响用户什么功能
    </p>
    <p>
      位置1、用以做支付风控；2、帮用户检查银行位置1、通过用户每次登录的位置判断该用户是否安全；2、推荐用户周边银行网点，方便用户找银行用户首次打开手机客户端时会弹窗询问是影响支付业务正常进行，有可能导致用户支付失败，同时银行位置检索功能无法使用
    </p>
    <p>
      通讯录手机话费充值用户可以选择通讯录里的联系人充值，免输号码，提升用户体验用户选择通讯录之前会弹窗询问是只能手动输入电话号码充值
    </p>
    <p>
      照片核心业务功能上传头像照片点击上传头像时会弹窗询问是无法上传头像照片
    </p>
    <p>
      相机核心业务功能1、扫码支付；2、做人脸识别风控校验；3、扫描银行卡识别卡号用户调用相机服务前会弹窗询问是无法进行扫码支付，无法通过人脸识别进行风控校验，无法扫描银行卡
    </p>
    <p>
      通知全部功能接收消息用户首次打开手机客户端时会弹窗询问是用户无法接受到支付的通知信息
    </p>
    <p>
      无线数据全部功能连接网络程序启动时检测网络状态，弹窗询问是APP无法正常使用
    </p>
    <p>
      开启WLAN全部功能连接网络程序启动时检测网络状态，弹窗询问是APP无法正常使用
    </p>
    <p>
      存储全部功能写入存储用户信息，存储日志等信息用户首次打开手机客户端时会弹窗询问是APP无法正常使用
    </p>
    <p>
    ...
    <p>
      我们承诺对您的信息进行保密。除本政策及法律法规另有规定外，仅在下列情形下与支付关联公司、我们的供应商或合作伙伴共享您的信息。我们的供应商包括提供技术服务、电信服务、客户服务、风控服务、审计服务、法律服务的机构。合作伙伴包括金融机构、电子商务公司及平台、合作商户。以下将支付关联公司、我们的供应商及合作伙伴合称“第三方”。在和第三方合作前，我们会尽商业上的合理努力对该第三方的安全能力进行检测，评估其采集信息的正当合法必要性，并与第三方签订保密协议，对其查询行为进行技术监测，尽商业上的合理努力督促第三方在使用您的个人信息时遵守法律法规及协议中约定的保密和安全措施。一经发现其违反协议约定将会采取有效措施乃至终止合作：
    </p>
    <p>
    ...
    <p>
      3）如您参与抽奖、竞赛或类似推广活动，我们会将您提供的信息用于管理此类活动，如您中奖，可能会将您的手机号或支付登录名脱敏后以公布中奖名单。若该活动是我们和第三方联合推广的，我们可能与其共享活动过程中产生的、为完成活动所必要的个人信息（参加活动的用户数、中奖名单、中奖人联系方式），以便第三方能及时向您发放奖品或为您提供服务。
    </p>
    <p>
      4）为遵守适用的法律法规及监管规定、维护社会公共利益，或保护我们的其他用户、支付或支付员工的人身和财产安全或合法权益所合理必需的用途。
    </p>
    <p>
    ...
    <p>
      6）如您授权第三方向我们查询、采集您在支付的信息，则我们会在法律法规允许范围内及您对第三方的授权范围内向第三方共享您的信息。
    </p>
    <p>
      7）根据国家相关外汇监管法律法规及跨境电子商务政策，当您使用“支付”在跨境电子商务平台（包括但不限于考拉海购）进行跨境电子商务交易时，您授权并同意“支付”将您的支付信息及支付账户实名认证信息（包括姓名及身份证号码等）发送给跨境电子商务平台，以便跨境电子商务平台及“支付”为您提供代理购结汇服务，及向海关发送订购人信息用于清关。因此您还需同意该跨境电子商务平台需要您确认的相关协议，并承担由此所产生的法律后果。如需向境外相关第三方提供个人信息才能完成该交易的，经您授权后，且在符合法律、行政法规及监管规定的前提下，我们会向境外第三方提供该信息。该相关第三方所在地区可能有不同的个人信息保护法，我们将与该第三方签署保密协议，并将信息进行加密传输，尽商业上合理努力督促第三方在使用您的个人信息时遵守其适用的法律法规及协议约定的保密和安全措施。
    </p>
    <p>
      2、转让
    </p>
    ...
    <p>
      1、您可随时登录您的支付账户查询并管理该账户下您的个人信息，如您遇到任何障碍或疑问，可登录支付客服专区获取相关信息或拨打宝公司客服电话（400-0881188）或与在线客服联系。但出于安全性和身份识别的考虑或根据法律法规的强制规定，您可能无法修改注册时提供的初始注册信息。
    </p>
    <p>
      2、如您想改变授权范围，您可通过1)手机权限设置修改授权范围（设置流程详见帮助中心）；2)联系我们的客服邮箱，由客服引导并帮助您完成权限设置修改操作。当您取消信息收集的授权后，我们将不再收集该信息，但这可能影响您使用支付的部分或全部功能，详见本隐私政策（一）第7条。
    </p>
    <p>
      3、您可在登录支付账户后，在账户管理中管理或解绑您绑定的银行卡。
    </p>
    <p>
      4、您可根据支付服务协议第四条“注销”条款申请注销支付账户。
    </p>
    <p>
      您注销支付账户后，您该账户内的所有信息将被清空，我们将不会再收集、使用或共享与该账户相关的个人信息，但因您使用支付服务所留存的身份信息和支付业务信息，我们仍需按照监管要求的时间进行保存，且在该依法保存的时间内有权机关仍有权依法查询。为保护信息的安全性，支付制定了严格的账户及交易信息保护管理制度，定期对系统进行评测工作，并接受监管机关的监督与管理。
    </p>
    <p>
      5、如您发现我们采集、使用您个人信息的行为，违反了法律、行政法规规定或违反了与您的约定，您可联系我们的客服邮箱，要求删除该违反行为下采集的您的个人信息。
    </p>
    <p>
      6、如您发现我们采集、储存的您的个人信息有错误的，您可以联系我们的客服邮箱要求更正；
    </p>
    <p>
